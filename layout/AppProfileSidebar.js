						...
						<ul className="list-none m-0 p-0">
							<li>
								<a className="cursor-pointer flex surface-border mb-3 p-3 align-items-center border-1 surface-border border-round hover:surface-hover transition-colors transition-duration-150">
									<span>
										<img
											src={`${contextPath}/demo/images/avatar/circle/avatar-m-8.png`}
											alt="Avatar"
							...
							<li>
								<a className="cursor-pointer flex surface-border mb-3 p-3 align-items-center border-1 surface-border border-round hover:surface-hover transition-colors transition-duration-150">
									<span>
										<img
											src={`${contextPath}/demo/images/avatar/circle/avatar-f-8.png`}
											alt="Avatar"
											className="w-2rem h-2rem"
										/>
									</span>
							...
							<li>
								<a className="cursor-pointer flex surface-border mb-3 p-3 align-items-center border-1 surface-border border-round hover:surface-hover transition-colors transition-duration-150">
									<span>
										<img
											src={`${contextPath}/demo/images/avatar/circle/avatar-f-4.png`}
											alt="Avatar"
											className="w-2rem h-2rem"
										/>
									</span>
