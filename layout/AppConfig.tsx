			...
			<Sidebar
					...
					<>
						...
						<div className="field-radiobutton">
							<RadioButton
								...
								inputId="menutheme-colorscheme"></RadioButton>
						...
						<div className="field-radiobutton">
							<RadioButton
								...
								onChange={(e) => changeMenuTheme(e)}
								inputId="menutheme-primarycolor"></RadioButton>
						...
						<div className="field-radiobutton">
							<RadioButton
								...
								onChange={(e) => changeMenuTheme(e)}
								inputId="menutheme-transparent"></RadioButton>
				...
				<div className="field-radiobutton">
					<RadioButton
						...
						inputId="mode-light"></RadioButton>
